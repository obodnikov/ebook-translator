...
- **Рефлексия (reflect)** (если не `--no-reflect`): фрагменты с оценкой ≤ 3
  ...
  одному тексту, отбирает лишь 3 общих фрагмента из 17. Сама стадия
  оправдывает расход: на плохих фрагментах она сняла 53 процитированных
  дефекта из 55, тогда как все остальные стадии вместе — 24.
